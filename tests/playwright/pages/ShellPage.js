...
class ShellPage {
  constructor(page) {
    ...
    this.navProducts = page.locator(resolve('ShellPage.navProducts', '[data-test="nav-products"]'));
    this.navUsers = page.locator(resolve('ShellPage.navUsers', '[data-test="nav-users"]'));
    this.navOrders = page.locator(resolve('ShellPage.navOrders', '[data-test="nav-orders"]'));
