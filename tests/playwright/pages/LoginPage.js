...
class LoginPage {
  constructor(page) {
    this.page = page;
    this.usernameInput = page.locator(resolve('LoginPage.usernameInput', '[data-test="uname-TESTBATCH"]'));
    this.passwordInput = page.locator(resolve('LoginPage.passwordInput', '[data-test="password-TESTBATCH"]'));
